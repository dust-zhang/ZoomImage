...
{
    CGFloat duration    = (animated) ? 0.2 : 0.f;
...
#pragma mark - ZoomImageCache

@implementation ZoomImageCache
...
- (instancetype)init
{
    ...
    if(self)
    {
        ...
        _cachePath      = [rootCachePath stringByAppendingPathComponent:@"zoom.imagecache.tg"];
        
        if(![_fileManager fileExistsAtPath:@"zoom.imagecache.tg"])
        {
